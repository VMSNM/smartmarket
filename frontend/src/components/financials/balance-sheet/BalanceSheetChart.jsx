...
const BalanceSheetChart = () => {
    ...
    const [chartData, setChartData] = useState(balanceSheet.slice(0).reverse() || null);
        ...
        datasets: [
            {
                ...
                data: (chartData && chartData?.map(record => record.totalCurrentLiabilities)),
            ...
            },
            {
                ...
                data: (chartData && chartData?.map(record => record.totalCurrentAssets)),
            ...
            },
            {
                ...
                data: (chartData && chartData?.map(record => record.totalLiabilities)),
            ...
            {
                label: 'Total Assets',
                data: (chartData && chartData?.map(record => record.totalAssets)),
