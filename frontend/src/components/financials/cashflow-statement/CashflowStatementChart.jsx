...
const CashflowStatementChart = () => {
    ...
    const [chartData, setChartData] = useState(cashflowStatement.slice(0).reverse() || null);
    ...
    var data = {
        ...
        datasets: [
            {
                label: 'Free Cashflow',
                data: (chartData && chartData?.map(record => record.freeCashFlow)),
            ...
            },
            {
                ...
                data: (chartData && chartData.map(record => record.operatingCashFlow)),
            ...
            },
            {
                ...
                data: (chartData && chartData.map(record => record.capitalExpenditure)),
